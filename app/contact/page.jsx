...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "+91 9840626847",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "sanjaym984062@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    ...
    >
      <div className="container mx-auto pt-28">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              ...
              {/* <p className="text-white/60">
                I am passionate about collaborating on
          ...
          <div className="flex-1  xl:justify-end order-1 xl:order-none mb-8 xl:mb-0 ">
